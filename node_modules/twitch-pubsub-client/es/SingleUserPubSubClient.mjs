...
var SingleUserPubSubClient = /** @class */ (function () {
    ...
    SingleUserPubSubClient.prototype.onAutoModQueue = function (channel, callback) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._addListener('automod-queue', callback, 'channel:moderate', extractUserId(channel))];
            });
        });
    };
    /**
    ...
    SingleUserPubSubClient.prototype.onModAction = function (channel, callback) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._addListener('chat_moderator_actions', callback, 'channel:moderate', extractUserId(channel))];
            });
        });
    };
    /**
    ...
    SingleUserPubSubClient.prototype.onUserModeration = function (channel, callback) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._addListener('user-moderation-notifications', callback, 'chat:read', extractUserId(channel))];
            });
        });
    };
    /**
