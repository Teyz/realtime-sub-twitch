...
import type { PubSubUserModerationNotificationMessage, PubSubUserModerationNotificationMessageData } from './PubSubUserModerationNotificationMessage';
...
/** @private */
export declare type PubSubMessageData = PubSubAutoModQueueMessageData | PubSubBitsMessageData | PubSubBitsBadgeUnlockMessageData | PubSubChatModActionMessageData | PubSubRedemptionMessageData | PubSubSubscriptionMessageData | PubSubUserModerationNotificationMessageData | PubSubWhisperMessageData;
/** @private */
export declare type PubSubMessage = PubSubAutoModQueueMessage | PubSubBitsMessage | PubSubBitsBadgeUnlockMessage | PubSubChatModActionMessage | PubSubRedemptionMessage | PubSubSubscriptionMessage | PubSubUserModerationNotificationMessage | PubSubWhisperMessage;
