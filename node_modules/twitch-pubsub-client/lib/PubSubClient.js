...
var PubSubClient = /** @class */ (function () {
     ...
     */
    PubSubClient.prototype.onAutoModQueue = function (user, channel, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this.getUserListener(user).onAutoModQueue(channel, callback)];
            });
        });
    };
    /**
     ...
     */
    PubSubClient.prototype.onUserModeration = function (user, channel, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, this.getUserListener(user).onUserModeration(channel, callback)];
            });
        });
    };
    /**
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [2 /*return*/, twitch_common_1.extractUserId(user)];
                    case 1:
                        if (apiClient.tokenType === 'app') {
                            throw new twitch_auth_1.InvalidTokenTypeError('App tokens are not supported by PubSubClient; you need to pass authentication representing a user.');
                        }
                        return [4 /*yield*/, twitch_auth_1.getValidTokenFromProvider(apiClient)];
                    case 2:
    ...
    PubSubClient = PubSubClient_1 = tslib_1.__decorate([
        twitch_common_1.rtfm('twitch-pubsub-client', 'PubSubClient')
    ], PubSubClient);
    return PubSubClient;
}());
