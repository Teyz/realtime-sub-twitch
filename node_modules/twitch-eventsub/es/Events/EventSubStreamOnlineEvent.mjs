...
var EventSubStreamOnlineEvent = /** @class */ (function () {
     ...
     */
    EventSubStreamOnlineEvent.prototype.getStream = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._client.helix.streams.getStreamByUserId(this._data.broadcaster_user_id)];
                    case 1: return [2 /*return*/, (_a.sent())];
                }
            });
        });
    ...
    EventSubStreamOnlineEvent = __decorate([
        rtfm('twitch-eventsub', 'EventSubStreamOnlineEvent', 'broadcasterId')
