...
let EventSubChannelRaidSubscription = class EventSubChannelRaidSubscription extends EventSubSubscription {
    ...
    async _subscribe() {
        if (this._direction === 'from') {
            return await this._client._apiClient.helix.eventSub.subscribeToChannelRaidEventsFrom(this._userId, await this._getTransportOptions());
        }
        return await this._client._apiClient.helix.eventSub.subscribeToChannelRaidEventsTo(this._userId, await this._getTransportOptions());
    }
};
