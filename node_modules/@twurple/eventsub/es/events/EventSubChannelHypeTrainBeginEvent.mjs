 ...
 */
let EventSubChannelHypeTrainBeginEvent = class EventSubChannelHypeTrainBeginEvent {
    /** @private */
...
EventSubChannelHypeTrainBeginEvent = __decorate([
    rtfm('eventsub', 'EventSubChannelHypeTrainBeginEvent', 'broadcasterId')
], EventSubChannelHypeTrainBeginEvent);
export { EventSubChannelHypeTrainBeginEvent };
