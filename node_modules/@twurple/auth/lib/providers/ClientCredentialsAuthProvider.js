...
let ClientCredentialsAuthProvider = class ClientCredentialsAuthProvider {
     ...
     */
    async refresh() {
        return (this._token = await helpers_1.getAppToken(this._clientId, this._clientSecret));
    }
    /**
     * The client ID.
     */
...
ClientCredentialsAuthProvider = tslib_1.__decorate([
    common_1.rtfm('auth', 'ClientCredentialsAuthProvider', 'clientId')
