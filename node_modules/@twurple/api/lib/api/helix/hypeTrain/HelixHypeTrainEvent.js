 ...
 * A Hype Train event.
 */
let HelixHypeTrainEvent = class HelixHypeTrainEvent {
    /** @private */
    ...
    get topContributions() {
        return this._data.event_data.top_contributions.map(cont => new HelixHypeTrainContribution_1.HelixHypeTrainContribution(cont, this._client));
    }
};
tslib_1.__decorate([
