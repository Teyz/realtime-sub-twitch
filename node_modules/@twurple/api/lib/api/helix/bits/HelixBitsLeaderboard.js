 ...
 */
let HelixBitsLeaderboard = class HelixBitsLeaderboard {
    /** @private */
     ...
     */
    get entries() {
        return this._data.data.map(entry => new HelixBitsLeaderboardEntry_1.HelixBitsLeaderboardEntry(entry, this._client));
    }
    /**
