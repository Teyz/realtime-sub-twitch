...
let HelixWebHooksApi = class HelixWebHooksApi extends BaseApi_1.BaseApi {
    ...
    getSubscriptionsPaginated() {
        return new HelixPaginatedRequestWithTotal_1.HelixPaginatedRequestWithTotal({
            url: 'webhooks/subscriptions'
        }, this._client, data => new HelixWebHookSubscription_1.HelixWebHookSubscription(data, this._client));
    }
    /**
...
HelixWebHooksApi = tslib_1.__decorate([
    common_1.rtfm('api', 'HelixWebHooksApi')
], HelixWebHooksApi);
