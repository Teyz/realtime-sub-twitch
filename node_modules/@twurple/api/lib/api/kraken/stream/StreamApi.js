 ...
 * ```
 */
let StreamApi = class StreamApi extends BaseApi_1.BaseApi {
    /**
    ...
    async getStreamByChannel(channel) {
        ...
        return data.stream ? new Stream_1.Stream(data.stream, this._client) : null;
    }
    /**
