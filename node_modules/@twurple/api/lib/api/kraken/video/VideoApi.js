...
const CreatedVideo_1 = require("./CreatedVideo");
 ...
 * ```
 */
let VideoApi = class VideoApi extends BaseApi_1.BaseApi {
    /**
    ...
    async getVideo(id) {
        ...
        return new Video_1.Video(data, this._client);
    }
    /**
    ...
    async getTopVideos(game, searchPeriod, type, languageCode, sort, page, limit = 10) {
        ...
        return data.vods.map(vod => new Video_1.Video(vod, this._client));
    }
    /**
    ...
    async createVideo(channel, createData) {
        ...
        return new CreatedVideo_1.CreatedVideo(data, this._client);
    }
    /**
