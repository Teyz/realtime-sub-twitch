 ...
 */
let HelixCustomRewardRedemption = class HelixCustomRewardRedemption {
    /** @private */
     ...
     */
    async getReward() {
        return (await this._client.helix.channelPoints.getCustomRewardById(this._data.broadcaster_id, this._data.reward.id));
    }
    /**
